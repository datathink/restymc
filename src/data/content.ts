...
export const services = [
  ...
  },
  {
    ...
    description: 'Does joining a class make you nervous? Are you recovering from an injury and desire a practice designed especially for you? Do you want to take yoga to a deeper, more personal level?',
    features: [],
...
export const workshops = [
  {
    ...
    description: 'Studies show that self-compassion leads to deeper curiosity, the capacity to look outward, boosts our mood, and strengthens our relationship with those we love most. Come learn the Three Pillars of Self-Love & how to cultivate it in our lives.',
    season: 'Winter' as const,
  },
  {
    id: 'motherhood',
    title: 'do you want to trust yourself more as a mother?',
    description: 'The first step is to understand yourself and your desires. Becoming the best version of yourself sets the best example for your children to gain their own sense of self and confidence.',
    season: 'Spring' as const,
  },
  {
    id: 'perfectionism',
    title: 'do you want to overcome perfectionism?',
    description: '"I\'m never going to make it." "I can\'t change." "I must make no mistakes to be loved." Get the tools you need to combat the thoughts that keep you stuck.',
    season: 'Fall' as const,
  },
  {
    id: 'advanced',
    title: 'take your yoga practice to the next level',
    description: 'Are you intimidated by arm balances or headstands? Do you want to deepen and enhance your experience with meditation? These workshops will take you where you need to go!',
    season: 'Fall' as const,
  },
];
...
export const instructors = [
  {
    id: 'julia',
    name: 'Julia',
    tagline: 'I believe yoga can heal & strengthen your body, your mind and your soul.',
    ...
    credentials: ['200+ hour certified yoga teacher', 'Trauma-informed', 'Mindfulness Coaching certification', 'BS in Marriage, Family & Human Development'],
    image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=500&fit=crop&crop=face',
  },
  {
    id: 'tierra',
    name: 'Tierra',
    tagline: 'I believe yoga helps create balance and harmony in our lives.',
    ...
    credentials: ['200+ hour certified yoga teacher', 'Specializes in restorative yoga', 'Children\'s yoga certified'],
...
export const yogaTherapyContent = {
  title: 'YogaTherapy',
  description: 'Throughout the year, we will be hosting weekend workshops & mini-retreats. You can also book your own event with us!',
