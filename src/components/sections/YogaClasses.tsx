          ...
          >
            ...
            <ul className="space-y-4 mb-8">
              {questions.map((question, index) => (
                ...
                >
                  <span className="mr-3 text-rest-sage text-lg">•</span>
                  <span className="font-script text-lg italic">{question}</span>
                </li>
              ))}
            </ul>
            ...
            <div className="bg-rest-tan/50 rounded-lg p-4 text-center mb-8">
              <p className="font-medium text-rest-charcoal">
                Come to a <span className="font-bold">FREE</span> class
              </p>
              <p className="text-sm text-rest-warm-gray">
                with code: <span className="font-bold text-rest-warm-brown">FREE</span>
              </p>
            </div>
